...
Saldırı yapmak için aşağıdaki komutu çalıştırıyoruz<br/>
...
Sonra `sslstrip` diyerek sslstrip'i çalıştırıyoruz. Bir başka terminale geçip aşağıdaki komutu çalıştırıyoruz.<br/>
